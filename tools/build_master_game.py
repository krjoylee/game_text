...
def build_demian_15_pack():
    ...
    return {
        ...
        "scenes": scenes,
        "endings": [
            {"min": 11, "title": "아브락사스에 도달한 자", "desc": "빛과 어둠의 세계를 모두 통합하고, 알을 깨고 나와 온전한 참 자아를 실현했습니다."},
            {"min": 7, "title": "표식을 지닌 자 (카인의 후예)", "desc": "세상의 규율에 굴복하지 않고 내면의 부름을 따르는 고결한 영혼의 소유자가 되었습니다."},
