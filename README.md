...
## 📖 프로젝트 소개: 《디비나 루두스(Divina Ludus)》의 의미와 철학

### 1. 어원과 제목의 탄생 배경
* **디비나 (Divina)**: 라틴어로 **'신성한(Divine)'**, '숭고한 영혼의 영역'을 뜻하며, 단테 알리기에리의 불멸의 서사시 **《신곡(La Divina Commedia)》**에서 유래했습니다.
* **루두스 (Ludus)**: 라틴어로 **'놀이(Play)'**, '게임(Game)', '연극 무대(Theatrical Play)'를 뜻하며, 요한 하위징아가 제창한 호모 루덴스(놀이하는 인간)의 본질을 가리킵니다.
* **이름이 탄생한 이유**:
  > **"박제된 고전문학의 숭고한 지혜(Divina)를, 누구나 살아서 뛰노는 인터랙티브 놀이와 연극(Ludus)으로 부활시킨다."**  
  서가 깊숙이 꽂혀 아무도 끝까지 읽지 않는 두껍고 무거운 고전을, 플레이어가 직접 대사를 읊고 고뇌하며 결단을 내리는 가장 가볍고 매력적인 텍스트 게임기로 재창조하는 영구 불멸의 팩 교체형 엔진 플랫폼입니다.

### 2. 기술적 정체성
수십 기가바이트의 용량과 화려한 3D 엔진이 범람하는 시대에, **"과거 1MB 롬팩에 모든 세계를 담아내던 고전 명작 게임들의 극소 용량 미학과 상상력"**을 현대적인 기술로 되살립니다.  
엔진 코어는 외부 런타임 의존성 없는 **순수 단일 실행 환경(Rust 네이티브 / Single-file 웹 콘솔)**으로 구동되며, 고전 명작 어드벤처(PC-98, 패미컴, MSX)의 문법을 현대 터미널과 미니멀 콘솔에 완벽하게 계승하였습니다.
