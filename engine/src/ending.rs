...
pub fn render_ending_screen(state: &GameState) {
    ...
    buf.grid[0][0] = crate::renderer::Cell { ch: '╔', is_continuation: false };
    buf.grid[0][w - 1] = crate::renderer::Cell { ch: '╗', is_continuation: false };
    buf.grid[h - 1][0] = crate::renderer::Cell { ch: '╚', is_continuation: false };
    buf.grid[h - 1][w - 1] = crate::renderer::Cell { ch: '╝', is_continuation: false };
    ...
    buf.grid[6][0] = crate::renderer::Cell { ch: '╠', is_continuation: false };
    buf.grid[6][w - 1] = crate::renderer::Cell { ch: '╣', is_continuation: false };
    ...
    buf.grid[sep2_row][0] = crate::renderer::Cell { ch: '╠', is_continuation: false };
    buf.grid[sep2_row][w - 1] = crate::renderer::Cell { ch: '╣', is_continuation: false };
...
pub fn render_game_over_screen(state: &GameState) {
    ...
    buf.grid[14][0] = crate::renderer::Cell { ch: '╠', is_continuation: false };
    buf.grid[14][w - 1] = crate::renderer::Cell { ch: '╣', is_continuation: false };
