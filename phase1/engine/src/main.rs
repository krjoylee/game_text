...
fn show_title_screen(state: &mut GameState) {
    loop {
        ...
        buf.grid[9][0] = crate::renderer::Cell { ch: '╠', is_continuation: false };
        buf.grid[9][w - 1] = crate::renderer::Cell { ch: '╣', is_continuation: false };
...
fn show_fail_screen(scene: &crate::model::Scene, state: &GameState) {
    ...
    buf.grid[11][0] = crate::renderer::Cell { ch: '╠', is_continuation: false };
    buf.grid[11][w - 1] = crate::renderer::Cell { ch: '╣', is_continuation: false };
